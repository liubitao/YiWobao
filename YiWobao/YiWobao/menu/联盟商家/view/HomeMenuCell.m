...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier menuArray:(NSMutableArray *)menuArray{
    ...
    if (self) {
        ...
        scrollView.contentSize = CGSizeMake(index*kScreenWidth, 180);
        ...
        //创建8个
        CGFloat itemWidth = (kScreenWidth-60)/4;
        for (int i = 0; i < menuArray.count; i++) {
            ...
            CGRect frame = CGRectMake( i%4*itemWidth + (index - 1)*kScreenWidth+30, ((i/4)%2 == 0)? 0:80, itemWidth, 80);
