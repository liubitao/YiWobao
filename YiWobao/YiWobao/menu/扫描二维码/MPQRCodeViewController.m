...
- (LBXScanViewStyle *)qqLBXScanViewStyle
{
    ...
    //线条上下移动图片
    style.animationImage = [UIImage imageNamed:@"line"];
...
- (void)scanResultWithArray:(NSArray<LBXScanResult*>*)array
{
    ...
    if (![strResult containsString:@"api.yiwob.com"]){
        return;
    }
    NSRange rage = [strResult rangeOfString:@"="];
    shopVC.shopID = [strResult substringFromIndex:rage.location+1];
