...
- (void)pushAnimateWithanimateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    //移动的目标位置
    CGRect finishFrame = [FrameAutoScaleLFL CGLFLMakeX:0 Y:0 width:375 height:287];
    UIView *containView = [transitionContext containerView];
    
    //背景视图 灰色高度
    CGFloat height = CGRectGetMaxY(finishFrame);
...
- (void)popAnimateWithanimateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    //起始位置
    CGRect originFrame = [FrameAutoScaleLFL CGLFLMakeX:0 Y:0 width:375 height:287];;
